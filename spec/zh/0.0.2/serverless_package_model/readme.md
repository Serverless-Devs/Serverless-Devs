...
- [Package 模型](./3.package_model.md)
  - [模型的组成](./3.package_model.md#模型的组成)
  - [模型的规范](./3.package_model.md#模型的规范)
    - [组件模型规范](./3.package_model.md#组件模型规范)
    - [应用模型规范](./3.package_model.md#应用模型规范)
    - [插件模型规范](./3.package_model.md#插件模型规范)
