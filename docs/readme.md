...
- 阿里云函数计算（FC）: [原始项目](https://github.com/devsapp/fc)
- AWS Lambda: [原始项目](https://github.com/devscomp/lambda)
- 百度智能云函数计算（CFC）: [原始项目](https://github.com/xinwuyun/cfc)
- 华为云函数工作流（FG）: [原始项目](https://github.com/xinwuyun/fg)
- 腾讯云云函数（SCF）: [原始项目](https://github.com/devscomp/scf)
