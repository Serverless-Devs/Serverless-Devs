...
export const SERVERLESS_API = SERVERLESS_HOST + '/api';
...
export const SERVERLESS_PUBLISH_PACKAGE_URL = SERVERLESS_API + '/package/put/object/url';
export const SERVERLESS_COMMAND_DESC_URL = SERVERLESS_API + '/package/command';
export const SERVERLESS_CHECK_VERSION_URL = SERVERLESS_API + '/package/object/version';

export const SERVERLESS_GUI_CLIENT_HOST = 'https://app-store-client.serverlessfans.com';
export const SERVERLESS_GUI_CLIENT_VERSION_CHECK = SERVERLESS_GUI_CLIENT_HOST + '/version.json';
